...
#c.NotebookApp.certfile = u'/home/wilhelm/jupyterhub-deploy-docker/secrets/data/cert.pem'
# c.NotebookApp.keyfile = '/root/.jupyter/privkey.pem'
# c.NotebookApp.certfile = '/root/.jupyter/fullchain.pem'
#c.NotebookApp.certfile = u'/etc/letsencrypt/live/wfr.ai/fullchain.pem'

#c.NotebookApp.keyfile  = u'/etc/letsencrypt/live/wfr.ai/privkey.pem'

#import os
#c.NotebookApp.certfile = os.path.expanduser('~') + '/jupyterhub-deploy-docker/secrets/data/fullchain.pem'
...
#c.NotebookApp.keyfile = u'/home/wilhelm/jupyterhub-deploy-docker/secrets/data/privkey.pem'
...
c.NotebookApp.password = "sha1:3fe3f5f59a80:f2ea21d82efaf1d5df11dd88d966698df558c4e5"
